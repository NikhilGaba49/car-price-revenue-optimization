#set the working directory to the folder of the R file and the dataset
#setwd("C:/Users/nikhi/Desktop/University of Melbourne BSCI/Second Year/Semester 1/Econometrics 1/Assignment 2")

# Load necessary libraries
library(stargazer)
library(AER)

# read in the required dataset for Assignment 2
...
#Question 1 - compute descriptive statistics for all the variables in the dataset
...
#Question 2 - Running separate single linear regressions between the three relationships
...
#Question 4 - running multiple regressions assuming heteroskedasticity and report summary statistics for each regression
...
# Question 5 - Confirming the direction of the bias term for each biased coefficient.
# Part B - We compare the signs of the coefficients to the correlations between two regressors.
...
#Question 6 - jointly testing hypothesis tests 
